...
import com.solicity.provider.AppLoginActivity;
import com.solicity.provider.BankDetailActivity;
import com.solicity.provider.BookingsActivity;
import com.solicity.provider.CardPaymentActivity;
import com.solicity.provider.ContactUsActivity;
import com.solicity.provider.DriverFeedbackActivity;
import com.solicity.provider.EmergencyContactActivity;
import com.solicity.provider.HelpActivity;
import com.solicity.provider.InviteFriendsActivity;
import com.solicity.provider.ListOfDocumentActivity;
import com.solicity.provider.ManageVehiclesActivity;
import com.solicity.provider.MyGalleryActivity;
import com.solicity.provider.MyProfileActivity;
import com.solicity.provider.MyWalletActivity;
import com.solicity.provider.NotificationActivity;
import com.solicity.provider.PrefranceActivity;
import com.solicity.provider.R;
import com.solicity.provider.SetAvailabilityActivity;
import com.solicity.provider.StaticPageActivity;
import com.solicity.provider.StatisticsActivity;
import com.solicity.provider.SubscriptionActivity;
import com.solicity.provider.UfxCategoryActivity;
import com.solicity.provider.UploadDocTypeWiseActivity;
import com.solicity.provider.VerifyInfoActivity;
import com.solicity.provider.WayBillActivity;
import com.solicity.provider.deliverAll.LiveTaskListActivity;
...
public class MyProfileFragment extends Fragment {
    ...
    View notificationView, paymentView, privacyView, myBookingView, addMoneyView, aboutUsView, myWalletView, statisticsView, wayBillView,
...
//        }
    ...
    public void setuserInfo() {
        ...
        Log.e("CheckName", "::" + vName + " "
                + vLastName);

        userNameTxt.setText(vName + " "
                + vLastName);
        userNameTxt_toolbar.setText(vName + " "
                + vLastName);
