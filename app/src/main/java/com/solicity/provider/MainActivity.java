...
public class MainActivity extends BaseActivity implements OnMapReadyCallback, GetLocationUpdates.LocationUpdatesListener, GoogleMap.OnCameraChangeListener, UpdateFrequentTask.OnTaskRunCalled,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (app_type.equals(Utils.CabGeneralType_UberX)) {
            ...
            ufxonlineOfflineSwitch.setOnClickListener(new View.OnClickListener() {
                @Override
            ...
            ufxonlineOfflineSwitch.setOnCheckedChangeListener((compoundButton, b) -> {
                ...
                if (generalFunc.retrieveValue("ENABLE_SAFETY_FEATURE_RIDE").equalsIgnoreCase("Yes") ||
                    ...
                    if (generalFunc.getJsonValueStr("ENABLE_SAFETY_CHECKLIST", obj_userProfile).equalsIgnoreCase("Yes") && b && iswitchClick) {
                        ...
                        Logger.d("URLCheck", "::" + generalFunc.getJsonValueStr("RESTRICT_PASSENGER_LIMIT_INFO", obj_userProfile));
                        bn.putString("URL", generalFunc.getJsonValueStr("RESTRICT_PASSENGER_LIMIT_INFO", obj_userProfile));
...
//            notificationImg.setVisibility(View.GONE);
            ...
            boolean isOnlyUfxServicesSelected = generalFunc.getJsonValueStr("isOnlyUfxServicesSelected", obj_userProfile).equalsIgnoreCase("Yes");
    ...
    public void goOnlineOffline(final boolean isGoOnline, final boolean isMessageShown) {
        ...
        exeWebServer.setDataResponseListener(responseString -> {
            ...
            if (responseString != null && !responseString.equals("")) {
                ...
                boolean isOnlyUfxServicesSelected = generalFunc.getJsonValue("isOnlyUfxServicesSelected", responseString).equalsIgnoreCase("Yes");
                selCarArea.setVisibility(isOnlyUfxServicesSelected ? View.GONE : View.VISIBLE);
                ...
                if (app_type.equals(Utils.CabGeneralType_Deliver)) {
                    return_action.setVisibility(View.GONE);
                    return_actionRTL.setVisibility(View.GONE);
                }
            } else {
...
//        }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        }/*Flutterwave Payment GateWay*/ else if (requestCode == RaveConstants.RAVE_REQUEST_CODE && data != null) {
