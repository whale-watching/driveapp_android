        ...
        if (!generalFunc.isDeliverOnlyEnabled()) {
            for (int i = 0; i < vehicleTypeListSize; i++) {
                ...
                if (eType.equalsIgnoreCase(Utils.eSystem_Type)) {
                    ...
                    deliverhelperTxt.setOnClickListener(new View.OnClickListener() {
                        @Override
                    ...
                    deliveryHelperimg.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            deliverhelperTxt.performClick();
