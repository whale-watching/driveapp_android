...
public class liveTaskListDataModel implements Serializable {
    ...
    public void setLiveTaskStatus(String liveTaskStatus) {
    ...
    public void setIsForDropoff(String isForDropoff) {
        this.isForDropoff = isForDropoff;
    }
    ...
    public void setIsForPickup(String isForPickup) {
        this.isForPickup = isForPickup;
    }


    public String getGenieOrderType() {
        return GenieOrderType;
    }

    public void setGenieOrderType(String genieOrderType) {
        GenieOrderType = genieOrderType;
    }

    public String geteBuyAnyService() {
        return eBuyAnyService;
    }

    public void seteBuyAnyService(String eBuyAnyService) {
        this.eBuyAnyService = eBuyAnyService;
    }
