...
import com.solicity.provider.AccountverificationActivity;
import com.solicity.provider.ActiveTripActivity;
import com.solicity.provider.AdditionalChargeActivity;
import com.solicity.provider.AllPermissionsHandleActivity;
import com.solicity.provider.CollectPaymentActivity;
import com.solicity.provider.DriverArrivedActivity;
import com.solicity.provider.MainActivity;
import android.Manifest;
import com.solicity.provider.SuspendedDriver_Activity;
import com.solicity.provider.TripRatingActivity;
...
//                    }
                    ...
                    } else if (generalFun.getJsonValueStr("eType", last_trip_data).equalsIgnoreCase("Ride") &&/*(generalFun.getJsonValueStr("ENABLE_MANUAL_TOLL_FEATURE", userProfileJsonObj).equalsIgnoreCase("Yes")||
