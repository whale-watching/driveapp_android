...
//        }
    ...
    public static void getDirectionservice(Context context, HashMap<String, String> mapdictionary, MapDelegate mapDelegate,boolean isLoader) {
        ...
        ExecuteWebServerUrl exeWebServer = new ExecuteWebServerUrl(context, url, true);
        exeWebServer.setLoaderConfig(context,isLoader,generalFunc);
            ...
            public void setResponse(String responseString) {
                ...
                if (responseString != null && !responseString.equals("")) {
                    ...
                    if (mapStrategy.equalsIgnoreCase("Advance") ) {
                        ...
                        hashMap.put("DIRECTION_RESULT_STR", responseString);
