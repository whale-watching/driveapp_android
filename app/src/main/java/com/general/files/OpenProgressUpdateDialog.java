...
public class OpenProgressUpdateDialog implements Runnable {
    ...
    public OpenProgressUpdateDialog(Context mContext, GeneralFunctions generalFunc,UploadProfileImage uploadProfileImage,boolean isGenie) {
    ...
    public void run() {
        ...
        if(isGenie)
        {
            uploadingTxt.setText(generalFunc.retrieveLangLBl("your documet is uploading", "LBL_GENIE_IMAGE_UPLOADING"));
        }
